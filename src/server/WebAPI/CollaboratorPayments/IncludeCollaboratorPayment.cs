...
public static class IncludeCollaboratorPayment
{
    ...
    HttpContext context)
    {
        ...
        context.Response.Headers.TriggerShowSuccessMessage("collaborator payment", "included", collaboratorPaymentId);
