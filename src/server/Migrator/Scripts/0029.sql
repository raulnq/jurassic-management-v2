ALTER TABLE $schema$.[CollaboratorPayments] ADD [ExcludeFromBankBalance] bit NOT NULL CONSTRAINT CollaboratorPayments_ExcludeFromBankBalance_Default default 0;
...
FROM $schema$.[MoneyExchanges]
UNION ALL
SELECT TaxPaymentId as RecordId, PaidAt, 'Expenses', CONCAT('Tax payment ',CAST([Year] as varchar(4)) + '-' + [Month]), 'PEN', Total, 0, Total, ITF, '', 'TaxPayments' as Source, CreatedAt, -1
